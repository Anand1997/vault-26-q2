#Dan-Harmon
This is a derivative of Hero’s Journey by #Joseph-Campbell (in " Hero with a Thousand Faces" )
![[dan-harmons-story-circle.jpg]]
The Story Circle as a narrative structure is **descriptive**, not prescriptive, meaning it doesn’t tell you what to write, but how to tell the story.
...
|         |                         |         |
| ------- | ----------------------- | ------- |
| Act I   | The order you know      | 1,2,3,8 |
| Act II  | Chaos (the upside-down) | 4,5,6,7 |
| Act III | The new order           | 8,1,2,3 |
> [!cite] The story circle cites #Christopher-Vogler and #Syd-Field.
